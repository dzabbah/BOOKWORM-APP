...
export default function Profile() {
  ...
  const handDeleteBook = async (bookId) => {
    try {
        ...
        Alert.alert("Success", "Recommendation successfully");
    } catch (error) {
 ...
 const confirmDelete = (bookId) => {
    Alert.alert("Delete recommandation", "Are you sure you want to delete this recommandation?", [
        { text: "Cancel", style:"cancel" },
        { text: "Delete", style:"destructive", onPress: () => handDeleteBook(bookId) },
    ])
 }
